...
token = 'Nzg0Mjc1ODcyNTM0MjMzMTI4.X8m70w.2F7yiZYauu0YmCWXZxdHlV8Y5vw'
...
async def lookup(selection, keywords, ctx):
    ...
    embed = discord.Embed(title='GOAT App Price Checker', color=0x33A1FF)
    embed.set_thumbnail(url=general['mainGlowPictureUrl'])
    embed.set_footer(icon_url='https://imgur.com/QNviAEl.png', text='Kitchen FNF')
